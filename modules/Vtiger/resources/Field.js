  ...
  {},
  {
    ...
    getUi: function () {
      ...
      if (
        ...
        html +=
          '<option value="">' + app.vtranslate('JS_SELECT_OPTION') + '</option>'
      }
      ...
      if (picklistColors) {
        ...
        for (option in picklistColors) {
          ...
          if (picklistColor) {
            ...
            html +=
              className +
              '{white: #ffffff !important; background-color: #38a767 !important;}'
          }
        }
        html += '<style>'
      }
    ...
    {},
    {
      ...
      getUi: function () {
        var html =
          ...
          this.getName() +
          '" value="0"/><input class="inputElement" type="checkbox" name="' +
          this.getName() +
          '" '
        if (this.isChecked()) {
          html += 'checked'
  ...
  {},
  {
    ...
    getUi: function () {
      var html =
        ...
        '<input class="timepicker-default form-control inputElement" type="text" data-format="' +
        this.getTimeFormat() +
        '" name="' +
        this.getName() +
        '" value="' +
