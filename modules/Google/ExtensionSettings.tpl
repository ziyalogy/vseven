...
<div class="col-sm-12 col-xs-12 extensionContents">
	...
	<form name="settingsForm" action="index.php" method="POST" >
		...
		<div class="row">
			<div class="col-sm-12 col-xs-12">
				<table class="listview-table table-striped table-bordered" align="center">
					<thead>
			...
			<div class="col-sm-12 col-xs-12">
				<div class="vt-default-callout vt-info-callout"> 
					...
					<div>
						...
						{vtranslate('LBL_REDIRECT_URL', $MODULE)} : <span style="color: #38a767 !important">{Google_Config_Connector::getRedirectUrl()}</span>
					</div>
					<br>
