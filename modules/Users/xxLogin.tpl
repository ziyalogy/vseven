				...
				<div id="loginFormDiv">
					<form class="form-horizontal" method="POST" action="index.php">
						...
						<div class="group">
							...
							<a class="forgotPasswordLink" style="color: #38a767;">forgot password?</a>
						</div>
					</form>
				</div>
				...
				<div id="forgotPasswordDiv" class="hide">
					<form class="form-horizontal" action="forgotPassword.php" method="POST">
						...
						<div class="group">
							...
							<span>Please enter details and submit<a class="forgotPasswordLink pull-right" style="color: #38a767;">Back</a></span>
						</div>
					</form>
				</div>
			</div>
