                                ...
                                <md-list-item class="md-2-line" ng-repeat="item in lineitems">
                                    <div layout="column" style="width: 100%;">
                                        ...
                                        <div layout="row" style="opacity: 0.9;">
                                            <p style="font-size: 14px; margin: 4px 0px;">{{item.quantity}} * {{item.listprice}}</p>
                                        </div>
                                        <div layout="column" flex style="opacity: 0.9">
                                            <p ng-if="item.discount_amount" style="font-size: 14px; margin: 4px 0px;" flex="100">(-) Discount Amount : {{item.discount_amount}}</p>
                                            <p ng-if="item.discount_percent"  style="font-size: 14px; margin: 4px 0px;" flex="100">(-) Discount Percentage : {{item.discount_percent}} (%)</p>
                                        </div>
                                        <div layout="row" style="text-align: right; color:darkgreen;">
                                            <p style="font-size: 14px; margin: 4px 0px; width: 100%;">{{item.netPrice}}</p>
                                        </div>
                                    </div>
                ...
                <md-tab label="Related">
                    <div ng-if="relatedModules" style="height:75vh; overflow: scroll;">
                        <md-list-item ng-repeat="(label, info) in relatedModules" ng-click="showRelatedList(info.relatedModule)">
                            <p style="font-size: 13px;"><span style="font-size: 14px; color:#FF4068" class="vicon-{{info.relatedModule | lowercase | nospace}}"></span> &nbsp;  {{label}}</p>
