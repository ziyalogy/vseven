;(function (t) {
  ...
  n.prototype = {
      ...
      var a = function (a, i) {
        ...
        if (angular.isDefined(a) && a !== null && a !== '') {
          if (angular.isString(a)) {
            if (
              typeof e.params.format !== 'undefined' &&
              e.params.format !== null
            ) {
    ...
    isPreviousMonthVisible: function () {
      return (
        this.calendarStart &&
        this.isAfterMinDate(
          t(this.calendarStart).startOf('month'),
          false,
          false,
        )
      )
    ...
    isNextMonthVisible: function () {
      return (
        this.calendarStart &&
        this.isBeforeMaxDate(t(this.calendarStart).endOf('month'), false, false)
      )
    },
    isPreviousYearVisible: function () {
      return (
        this.calendarStart &&
        this.isAfterMinDate(t(this.calendarStart).startOf('year'), false, false)
      )
    },
    isNextYearVisible: function () {
      return (
        this.calendarStart &&
        this.isBeforeMaxDate(t(this.calendarStart).endOf('year'), false, false)
      )
    },
    isHourAvailable: function (e) {
      ...
      return (
        this.isAfterMinDate(a, true, false) &&
        this.isBeforeMaxDate(a, true, false)
      )
    },
    isMinuteAvailable: function (e) {
      ...
      a.minute(e).second(0)
      return (
        this.isAfterMinDate(a, true, true) &&
        this.isBeforeMaxDate(a, true, true)
      )
    },
    start: function () {
      this.currentView = a.DATE
    ...
    .directive('mdcDatetimePickerCalendar', [
      function () {
        ...
        return {
          ...
          controller: [
            ...
            function (e) {
              ...
              i.isInRange = function (e) {
                return (
                  n.isAfterMinDate(t(e), false, false) &&
                  n.isBeforeMaxDate(t(e), false, false)
                )
              }
          ...
          template:
            '<md-virtual-repeat-container class="months">' +
            '<div md-virtual-repeat="idx in cal.months" md-start-index="cal.topIndex" md-item-size="' +
            n +
            '">' +
      ...
      function (t) {
              ...
              if (t) {
                ...
                if (r.isInRange(t)) {
                  ...
                  s = angular
                    ...
                    .attr(
                      'ng-class',
                      '{selected: cal.isSelectedDay(' + c + ')}',
                    )
                    .attr('ng-click', 'cal.selectDate(' + c + ')')
                } else {
        ...
        return {
          ...
          template:
            ...
            '<table class="table table-stripeddtp-picker-days">' +
            '    <thead>' +
            '    <tr>' +
  ...
  angular.module(e).directive('mdcDatetimePickerClock', [
    function () {
      var t =
      ...
      return {
        ...
        link: function (t, e, a) {
          ...
          var c = function () {
            ...
            var E = M / 1.5
            angular
              .element(e[0].querySelector('.dtp-hour-hand'))
              .css({
                left: M + g * 1.5 + 'px',
                height: P + 'px',
                marginTop: M - P - v + 'px',
              ...
              .addClass(!r ? 'on' : '')
            angular
              .element(e[0].querySelector('.dtp-minute-hand'))
              .css({
                left: M + g * 1.5 + 'px',
                height: E + 'px',
                marginTop: M - E - v + 'px',
          ...
          var l = function () {
            ...
            var i = t.minute()
            o(
              angular.element(e[0].querySelector('.dtp-hour-hand')),
              (360 / 12) * a,
            )
