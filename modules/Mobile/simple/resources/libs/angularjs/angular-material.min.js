...
!(function (e, t, n) {
  ...
  !(function () {
    ...
    (function () {
      function e(e, n, o) {
        ...
        var u = {},
          ...
          f = {}
        return (
          (r.getResponsiveAttribute = l),
          (r.getQuery = c),
          (r.watchResponsiveAttributes = s),
          r
        )
      }
        ...
        var u = l.startSymbol(),
          ...
          f = {
            ...
            findFocusTarget: function (e, n) {
              var o,
                r = e[0].querySelectorAll(n || '[md-autofocus]')
              return (
                r.length &&
            ...
            disableScrollAround: function (e, n) {
              ...
              return (f.disableScrollAround._enableScrolling = function () {
                --f.disableScrollAround._count ||
                  (c(), l(), delete f.disableScrollAround._enableScrolling)
              })
            },
            ...
            extractElementByName: function (e, n) {
              ...
              return (
                s.warn(
                  f.supplant("Unable to find node '{0}' in element.", [n]),
                ),
                e
              )
            },
        ...
        function e(e) {
          ...
          function i(n, o) {
            ...
            var a,
              l,
              s = n(),
              m = { hide: s.hide, cancel: s.cancel, show: r }
            return (
              (a = c.methods || []),
              (l = i(c.optionsFactory, {})),
          ...
          var a = ['onHide', 'onShow', 'onRemove'],
            d = {},
            c = { presets: {} },
            l = { setDefaults: n, addPreset: r, addMethod: o, $get: i }
          return (
            l.addPreset('build', {
              methods: [
                'controller',
        ...
        function o(e, o, r, i, a, d, c, l, s, m) {
          return function () {
            ...
            function u(e, t) {
              function r(t) {
                return (
                  t.remove(e || b, !1)['catch'](function (e) {}),
                  t.deferred.promise
                )
              }
            ...
            function h(e) {
              var t = E.shift()
              return t
                ? (t.remove(e || g, !0)['catch'](function (e) {}),
                  t.deferred.promise)
                : o.when(e || g)
            }
            function p(m) {
              ...
              function h(e, t) {
                return (
                  m.cancelAutoHide && m.cancelAutoHide(),
                  o(function (n, r) {
                    function i() {
                    ...
                    o.when(A)['finally'](function () {
                      m.element.triggerHandler('$mdInterimElementRemove'),
                        $(m.element, m).then(function () {
                          ;(t && a(e)) || i()
                        }, a)
                    })
                  })
              ...
              function b(e, n) {
                ...
                return (
                  (n.element = o), (n.parent = E(o, n)), n.themable && s(o), o
                )
              }
              function E(n, o) {
                var r = o.parent
                if (
                  ((r = t.isFunction(r)
                    ? r(o.scope, n, o)
                    : t.element(t.isString(r) ? e[0].querySelector(r) : r)),
                  !(r || {}).length)
                ) {
                  var i
                  return (
                    a[0] &&
                      a[0].querySelector &&
                      (i = a[0].querySelector(':not(svg) > body')),
                    i || (i = a[0]),
              ...
              return (
                (m = p(m)),
                (y = { options: m, deferred: o.defer(), show: u, remove: h })
              )
            }
            var f,
              g = !1,
              b = !0,
              E = []
            return (f = { show: m, hide: u, cancel: h })
          }
        }
        return (
          (e.$get = o),
      ...
      !(function () {
        function e(e, t) {
          function n(n, o, r) {
            ...
            if (
              (t && o.addClass(e),
              r[i] && o.addClass(e + '-' + r[i].replace(/\s+/g, '-')),
              n)
            ) {
              var a
              r.$observe(
        ...
        t.module('material.core.layout', ['ng'])
          .directive('layout', e('layout', !0))
          .directive('layoutSm', e('layout-sm', !0))
          .directive('layoutGtSm', e('layout-gt-sm', !0))
          .directive('layoutLtMd', o('layout-lt-md', !0))
          .directive('layoutMd', e('layout-md', !0))
          .directive('layoutGtMd', e('layout-gt-md', !0))
          .directive('layoutLtLg', o('layout-lt-lg', !0))
          .directive('layoutLg', e('layout-lg', !0))
          .directive('layoutGtLg', e('layout-gt-lg', !0))
          .directive('flex', e('flex', !0))
          .directive('flexSm', e('flex-sm', !0))
          .directive('flexGtSm', e('flex-gt-sm', !0))
          .directive('flexLtMd', o('flex-lt-md', !0))
          .directive('flexMd', e('flex-md', !0))
          .directive('flexGtMd', e('flex-gt-md', !0))
          .directive('flexLtLg', o('flex-lt-lg', !0))
          .directive('flexLg', e('flex-lg', !0))
          .directive('flexGtLg', e('flex-gt-lg', !0))
          ...
          .directive('layoutAlignLtMd', o('layout-align-lt-md'))
          .directive('layoutAlignMd', e('layout-align-md'))
          .directive('layoutAlignGtMd', e('layout-align-gt-md'))
          .directive('layoutAlignLtLg', o('layout-align-lt-lg'))
          ...
          .directive('flexOrderLtMd', o('flex-order-lt-md'))
          .directive('flexOrderMd', e('flex-order-md'))
          .directive('flexOrderGtMd', e('flex-order-gt-md'))
          .directive('flexOrderLtLg', o('flex-order-lt-lg'))
          ...
          .directive('offsetLtMd', o('offset-lt-md'))
          .directive('offsetMd', e('offset-md'))
          .directive('offsetGtMd', e('offset-gt-md'))
          .directive('offsetLtLg', o('offset-lt-lg'))
          .directive('offsetLg', e('offset-lg'))
          .directive('offsetGtLg', e('offset-gt-lg'))
          .directive('layoutMargin', n('layout-margin'))
          .directive('layoutPadding', n('layout-padding'))
          .directive('layoutWrap', n('layout-wrap'))
          .directive('layoutFill', n('layout-fill'))
          .directive('hide', n('hide'))
          .directive('hideSm', n('hide-sm'))
          .directive('hideGtSm', n('hide-gt-sm'))
          .directive('hideLtMd', o('hide-lt-md'))
          .directive('hideMd', n('hide-md'))
          .directive('hideGtMd', n('hide-gt-md'))
          .directive('hideLtLg', o('hide-lt-lg'))
          .directive('hideLg', n('hide-lg'))
          .directive('hideGtLg', n('hide-gt-lg'))
          .directive('show', n('show'))
          .directive('showSm', n('show-sm'))
          .directive('showGtSm', n('show-gt-sm'))
          .directive('showLtMd', o('show-lt-md'))
          .directive('showMd', n('show-md'))
          .directive('showGtMd', n('show-gt-md'))
          .directive('showLtLg', o('show-lt-lg'))
          .directive('showLg', n('show-lg'))
          .directive('showGtLg', n('show-gt-lg'))
      })()
    })(),
    (function () {
      function e(e, n) {
    ...
    (function () {
          ...
          (o = o.replace(m, function (t, n, o, r, i) {
            return 'foreground' === n
              ...
              : (0 === o.indexOf('hue') && (o = e.colors[n].hues[o]),
                l((s[e.colors[n].name][o] || '')[i ? 'contrast' : 'value'], r))
          })),
      ...
      function d(e, t) {
        if (!s[(e.colors[t] || {}).name])
          throw new Error(
            "You supplied an invalid color palette for theme %1's %2 palette. Available palettes: %3"
              .replace('%1', e.name)
              .replace('%2', t)
              .replace('%3', Object.keys(s).join(', ')),
          )
      }
      function c(e) {
          ...
          calculateZoomToOrigin: function (n, o) {
            ...
            if (r) {
              ...
              c = d({
                ...
                centerY: u.y - m.y,
                scaleX:
                  Math.round(100 * Math.min(0.5, l.width / s.width)) / 100,
                scaleY:
                  Math.round(100 * Math.min(0.5, l.height / s.height)) / 100,
              })
            }
            return c
          },
    ...
    (function () {
      t.version.minor >= 4
        ...
        : !(function () {
            ...
            t.module('material.core.animate', [])
              .factory('$$forceReflow', l)
              .factory('$$AnimateRunner', m)
              .factory('$$rAFMutex', s)
              .factory('$animateCss', [
                '$window',
                '$$rAF',
                ...
                '$$jqLite',
                '$timeout',
                function (e, t, n, l, s, m) {
                  function u(t, i) {
                    var l = [],
                      s = M(t)
                    i.transitionStyle &&
                      l.push([a + 'transition', i.transitionStyle]),
                      i.keyframeStyle &&
                        l.push([a + 'animation', i.keyframeStyle]),
                      i.delay &&
                        l.push([a + 'transition-delay', i.delay + 's']),
                      i.duration &&
                        l.push([a + 'transition-duration', i.duration + 's'])
                    var u =
                        i.keyframeStyle ||
                        (i.to && (i.duration > 0 || i.transitionStyle)),
                        ...
                        return (
                          g(function () {
                            ...
                            i.easing &&
                              ...
                              i.delay &&
                                n.animationDelay &&
                                u.push([a + 'animation-delay', i.delay + 's']),
                              i.duration &&
                                n.animationDuration &&
                                u.push([
                            ...
                            var f = n.delay,
                              ...
                              M = Date.now()
                            ;(C = []),
                              n.transitionDuration && C.push(d),
                              n.animationDuration && C.push(c),
                              (C = C.join(' ')),
                              (A = function (t) {
                                t.stopPropagation()
                  ...
                  function h(e, t) {
                    t.addClass &&
                      (s.addClass(e, t.addClass), (t.addClass = null)),
                      t.removeClass &&
        ...
        function n(e, n, i, a, d, c, l) {
          function s(o, r, l, s) {
            ;(r = i.extractElementByName(r, 'md-bottom-sheet')),
              ...
              a.inherit(h, l.parent),
              e.enter(h, l.parent, null)
            var m = new u(r, l.parent)
            return (
              (l.bottomSheet = m),
              l.targetEvent && t.element(l.targetEvent.target).blur(),
              a.inherit(m.element, l.parent),
              l.disableParentScroll &&
                (l.restoreScroll = i.disableScrollAround(m.element, l.parent)),
              e.enter(m.element, l.parent).then(function () {
                var e =
                  i.findFocusTarget(r) ||
                  t.element(
          ...
          function u(e, t) {
            ...
            return (
              t.on('$md.dragstart', a).on('$md.drag', c).on('$md.dragend', s),
              {
                element: e,
                cleanup: function () {
                  m(),
            ...
            function (d, l, s, m) {
              ...
              function h(e) {
                ...
                ;(t === o.KEY_CODE.SPACE || t === o.KEY_CODE.ENTER) &&
                  (e.preventDefault(),
                  l.hasClass('md-focused') || l.addClass('md-focused'),
                  p(e))
              }
              function p(e) {
              ...
              ;(m = m || i.fakeNgModel()),
                ...
                s.ngChecked &&
                  d.$watch(
                    d.$eval.bind(d, s.ngChecked),
                    m.$setViewValue.bind(m),
                  ),
                u('ngDisabled', 'tabindex', { true: '-1', false: s.tabindex }),
                n.expectWithText(l, 'aria-label'),
                e.link.pre(d, { on: t.noop, 0: {} }, s, [m]),
                (d.mouseActive = !1),
                l
                  .on('click', p)
                  .on('keypress', h)
      ...
      !(function () {
        ...
        ;(n.$inject = ['$element', '$$mdDateUtil', '$mdDateLocale']),
          ...
          (n.prototype.buildCalendarForMonth = function (e) {
            ...
            if (
              (s.classList.add('md-calendar-month-label'),
              this.calendarCtrl.maxDate &&
                n > this.calendarCtrl.maxDate &&
                s.classList.add('md-calendar-month-label-disabled'),
              (s.textContent = this.dateLocale.monthHeaderFormatter(t)),
              2 >= o)
            ) {
      ...
      !(function () {
        ...
        function n(e, n, o, r, i, a, d, c, l, s, m) {
          ;(this.$compile = r),
            ...
            (this.calendarPane.id = 'md-date-pane' + c.nextUid()),
            d(n),
        ...
        ;(n.$inject = [
          ...
          (n.prototype.attachChangeListeners = function () {
            ...
            e.$scope.$on('md-calendar-change', function (t, n) {
              e.ngModelCtrl.$setViewValue(n),
                ...
                e.inputContainer.classList.remove(r)
            }),
              e.ngInputElement.on('input', t.bind(e, e.resizeInputElement)),
              e.ngInputElement.on(
                'input',
                e.$mdUtil.debounce(e.handleInputEvent, i, e),
              )
          }),
          ...
          (n.prototype.installPropertyInterceptors = function () {
            ...
            this.$attrs.ngDisabled &&
              this.$element
                .scope()
                .$watch(this.$attrs.ngDisabled, function (t) {
                  e.setDisabled(t)
                }),
          ...
          (n.prototype.handleInputEvent = function () {
            ...
            this.dateUtil.setDateTimeToMidnight(t),
              ...
              this.dateUtil.isDateWithinRange(t, this.minDate, this.maxDate)
                ? (this.ngModelCtrl.$setViewValue(t),
                  (this.date = t),
                  this.inputContainer.classList.remove(r))
                : this.inputContainer.classList.toggle(r, e)
          }),
          (n.prototype.attachCalendarPane = function () {
            ...
            ;(e.style.left = t.left - n.left + 'px'),
              (e.style.top = t.top - n.top + 'px'),
          ...
          link: function (o, r, i) {
            n(r),
              e(function () {
                ...
                var n,
                  o = r[0].querySelector('md-dialog-content')
                o &&
                  ((n = o.getElementsByTagName('img')),
                  e(),
      ...
      function n(e) {
        ...
        function o(e, n, o, r, i, a, d, c) {
          function l(e, n, r, i) {
            ...
            return (
              (n = o.extractElementByName(n, 'md-dialog')),
          ...
          function m(e, n) {
            var o = { element: null, bounds: null, focus: t.noop }
            n.origin = t.extend({}, o, n.origin || {})
            var r = t.element((n.targetEvent || {}).target)
            r &&
              r.length &&
              ((n.origin.element = r),
              (n.origin.bounds = r[0].getBoundingClientRect()),
          ...
          function h(e, t, n) {
            n.disableParentScroll &&
              ...
              (n.hideBackdrop = function () {
                n.backdrop && i.leave(n.backdrop),
                  n.disableParentScroll &&
      ...
      !(function () {
        function n(n, o, r, i, a) {
          ...
          function s(e) {
            ...
            do
              (o = e.map(function (e) {
                ...
                n ||
                  ((e = m(e)),
                  (r = e.length >= I.length && e.length !== o.length))
            while (10 > i && !n && r)
            return n
          }
          function m(e) {
          ...
          function u(e) {
            return (
              I.push(e.type),
              s(['mousedown', 'focusout?', 'focusin?', 'mouseup', 'click'])
                ? (N(e), void l())
                : s(['touchstart?', 'touchend?', 'click'])
                ? (N(e), void l())
                : s(['focusin'])
                ? (H.open(), void l())
                : s(['focusout'])
          ...
          function y(e, n) {
            ...
            t.forEach(o, function (e) {
              ...
              (H.currentActionIndex = H.currentActionIndex + n),
              (H.currentActionIndex = Math.min(
                o.length - 1,
                H.currentActionIndex,
              )),
              (H.currentActionIndex = Math.max(0, H.currentActionIndex))
          ...
          function e(e) {
            ...
            t.forEach(i, function (e, t) {
              ...
              ;(o.opacity = r.isOpen ? 1 : 0),
                (o.transform = o.webkitTransform = r.isOpen
                  ? 'scale(1)'
                  : 'scale(0)'),
      ...
      function e(e, o, r, i) {
        function a(n, a, d, c) {
          ...
          function p(e, t, n, o, r, i, a) {
            var d = (1 / n) * 100,
              c = (n - 1) / n,
              l = x({ share: d, gutterShare: c, gutter: r }),
              s = {
            ...
            switch (i) {
              case 'fixed':
                ;(s.top = N({ unit: a, offset: e.row, gutter: r })),
                  (s.height = _({ unit: a, span: t.row, gutter: r }))
                break
              case 'ratio':
                var m = d / a,
                  u = x({ share: m, gutterShare: c, gutter: r })
                ;(s.paddingTop = _({ unit: u, span: t.row, gutter: r })),
                  (s.marginTop = N({ unit: u, offset: e.row, gutter: r }))
                break
              case 'fit':
                var h = (o - 1) / o,
                  m = (1 / o) * 100,
                  u = x({ share: m, gutterShare: h, gutter: r })
                ;(s.top = N({ unit: u, offset: e.row, gutter: r })),
                  (s.height = _({ unit: u, span: t.row, gutter: r }))
            }
            return s
          }
            ...
            switch (o) {
              ...
              case 'ratio':
                var a = 1 === e ? 0 : (e - 1) / e,
                  d = (1 / e) * 100,
                  c = d * (1 / r),
                  l = x({ share: c, gutterShare: a, gutter: n })
        ...
        function r(r, i, a, d) {
          ...
          if (m) {
            ...
            ;(m.input = i),
              ...
              'textarea' === i[0].tagName.toLowerCase() && s(),
              u || l()
            var f =
              m.isErrorGetter ||
              function () {
                ...
                t.isNumber(n) && n > 0
                  ? (s.parent().length ||
                      e.enter(
                        s,
                        l.element,
                        t.element(l.element[0].lastElementChild),
                      ),
                    a())
                  : e.leave(s)
            }),
      ...
      function i(e) {
        function n(n, o, r, i) {
          if (i && !t.isDefined(i.element.attr('md-no-float'))) {
            var a = r.placeholder
            if (
              (o.removeAttr('placeholder'), 0 == i.element.find('label').length)
            ) {
          ...
          compile: function (i, a) {
            ...
            function c(n) {
              ...
              if (
                ...
                d.attr('ng-click', h.getAttribute('ng-click')),
              ...
              h &&
                (h.hasAttribute('ng-click') || (a.ngClick && l(h))) &&
                (i.addClass('md-with-secondary'), i.append(h))
            }
            function l(e) {
            ...
            var m,
              u,
              h = i[0].querySelector('.md-secondary')
      ...
      function e(e, o, r, i, a, d, c) {
        function l(a, l) {
          ...
          if (
            ...
            s[0].hasAttribute('id') ||
              s.attr('id', 'select_value_label_' + o.nextUid()),
          ...
          return (
            ...
            function (a, l, s, m) {
              ...
              if ($) {
                ...
                ;($.input = l),
                  $.label || i.expect(l, 'aria-label', l.attr('placeholder')),
                  a.$watch(w, $.setInvalid)
              }
              var x, N, _
              if ((g(), r(l), s.name && A)) {
                var S = l
                ...
                (y.setIsPlaceholder = function (e) {
                  e
                    ? (T.addClass('md-select-placeholder'),
                      $ &&
                        $.label &&
                        $.label.addClass('md-placeholder md-static'))
              ...
              s.$observe('ngMultiple', function (e) {
                ...
                s.$observe('disabled', function (e) {
                  'string' == typeof e && (e = !0),
                    (M === n || M !== e) &&
                      ((M = e),
                      e
                        ? (l.attr({ tabindex: -1, 'aria-disabled': 'true' }),
                          l.off('click', E),
                          l.off('keydown', b))
                        : (l.attr({
                            tabindex: s.tabindex,
                ...
                s.disabled ||
                  s.ngDisabled ||
                  (l.attr({ tabindex: s.tabindex, 'aria-disabled': 'false' }),
                  l.on('click', E),
                  l.on('keydown', b))
              var O = { role: 'combobox', 'aria-expanded': 'false' }
              l[0].hasAttribute('id') || (O.id = 'select_' + o.nextUid()),
                l.attr(O),
      ...
      function o(e, o, r) {
              ...
              e.$apply(function () {
                s.isMultiple
                  ? d
                    ...
                    : s.select(a, i.value)
                  : d ||
                    (s.deselect(Object.keys(s.selected)[0]),
                    s.select(a, i.value)),
                  s.refreshViewValue()
              })
            }
        ...
        function a(r, i, a) {
          ...
          function l() {
            ...
            Object.keys(s.selected).forEach(s.deselect),
              s.select(s.hashGetter(e), e)
          }
          var s = this
          ;(s.isMultiple = t.isDefined(i.multiple)),
            (s.selected = {}),
            (s.options = {}),
            r.$watch(
              function () {
          ...
          ;(s.optNodeForKeyboardSearch = function (e) {
            ...
            (s.addOption = function (e, n) {
              ...
              ;(s.options[e] = n),
                t.isDefined(s.selected[e]) &&
                  (s.select(e, n.value), s.refreshViewValue())
            }),
            ...
            (s.refreshViewValue = function () {
              var e,
                t = []
              for (var n in s.selected)
                t.push((e = s.options[n]) ? e.value : s.selected[n])
      ...
      function r(e, n) {
        ...
        function r(o, r, i, a) {
          ...
          t.isDefined(i.ngValue)
            ? o.$watch(i.ngValue, d)
            : t.isDefined(i.value)
            ? d(isNaN(i.value) ? i.value : Number(i.value))
            : o.$watch(function () {
                return r.text()
              }, d),
                ...
                t.isDefined(e) &&
                  ...
                  e
                    ? (s.isMultiple || s.deselect(Object.keys(s.selected)[0]),
                      s.select(l.hashKey, l.value))
                    : s.deselect(l.hashKey),
                  s.refreshViewValue(),
                  s.ngModel.$render())
              })
            }),
        ...
        function o(e, o, c, l, s, m, u, h) {
          ...
          function f(r, i, a) {
            ...
            function f(e, t, n) {
              return (
                ...
                function () {
                  n.backdrop && h.leave(n.backdrop, { duration: 0 }),
                    n.disableParentScroll &&
                      (n.restoreScroll(), delete n.restoreScroll)
                }
              )
          ...
          function v(e, n, o) {
            ...
            'MD-OPTGROUP' === (w.tagName || '').toUpperCase() &&
              ((w = s[0] || g.firstElementChild || g), (m = w)),
              (o.focusedNode = w)
            ...
            if (C) {
              ...
              ;(g.scrollTop = N.top + N.height / 2 - S),
                $.top < S
                  ? (g.scrollTop = Math.min(N.top, g.scrollTop + S - $.top))
                  : $.bottom < S &&
                    (g.scrollTop = Math.max(
                      N.top + N.height - x.height,
                      g.scrollTop - S + $.bottom,
                    ))
            }
            var H, D, I, O
            v
              ...
              : ((H = E.left + N.left - N.paddingLeft + 2),
                (D =
                  Math.floor(
        ...
        function m(o, s, m, u) {
          ...
          function E() {
            if (t.isDefined(m.mdDiscrete) && !t.isUndefined(Q)) {
              ...
              if (!Z) {
                ;(Z = t.element('<canvas style="position:absolute;">')),
                  V.append(Z)
                var r = n.getComputedStyle(V[0])
                ;(J = Z[0].getContext('2d')),
                  (J.fillStyle = r.backgroundColor || 'black')
              }
              var i = M()
              ;(Z[0].width = i.width), (Z[0].height = i.height)
              for (var a, d = 0; o >= d; d++)
                (a = Math.floor(i.width * (d / o))),
                  J.fillRect(a - 1, 0, 2, i.height)
            }
          }
          function v() {
          ...
          function $(e) {
            if (!s[0].hasAttribute('disabled')) {
              ...
              e.keyCode === i.KEY_CODE.LEFT_ARROW
                ? (t = -Q)
                : e.keyCode === i.KEY_CODE.RIGHT_ARROW && (t = Q),
                t &&
          ...
          function C() {
            ...
            ;(o.modelValue = u.$viewValue),
              s.attr('aria-valuenow', u.$viewValue),
              k(e),
              U.text(u.$viewValue)
          }
          function A(e) {
          ...
          function N(e) {
            F() ||
              ((te = !0), e.stopPropagation(), s.addClass('dragging'), H(e))
          }
          function _(e) {
          ...
          var Y = t.noop
          m.ngDisabled && (Y = o.$parent.$watch(m.ngDisabled, b)),
            d.register(s, 'drag'),
            s
              .on('keydown', $)
              .on('$md.pressdown', w)
              ...
              function u(e) {
                if (E) {
                  ...
                  ;(n = Math.max(0, Math.min(1, n))),
                    g.css(i.CSS.TRANSFORM, 'translate3d(' + 100 * n + '%,0,0)'),
                    (E.translate = n)
                }
              }
              function h(e) {
                if (E) {
                  e.stopPropagation(),
                    ...
                    g.css(i.CSS.TRANSFORM, '')
                  var t = s.$viewValue ? E.translate < 0.5 : E.translate > 0.5
    ...
    (function () {
      ...
      function n(e) {
        function t(e, t, o) {
          ...
          function i(t, n, o) {
            return (
              n.off(d, o.onSwipe), o.parent.removeClass(o.openClass), e.leave(n)
            )
          }
          function a(e) {
          ...
          link: function (d, c, l) {
            function s() {
              ...
              var p,
                ...
                b = 0,
                E = 0,
                v = l.mdShrinkSpeedFactor || 0.5,
                M = e.throttle(m),
                $ = o.debounce(h, 5e3)
              d.$on('$mdContentLoaded', s),
                l.$observe('mdScrollShrink', r),
                d.$on('$destroy', g)
            }
    ...
    (function () {
      function e(e, n, o, r, i, a, d, c, l) {
        function s(s, h, p) {
          ...
          function v() {
            for (var e = h.parent(); e && $('pointer-events', 'none', e[0]); )
              e = e.parent()
            return e
          }
          function M() {
          ...
          function y() {
            ...
            var d = function (e) {
              ...
              c = function () {
                var t = s.hasOwnProperty('autohide')
                  ? s.autohide
                  : p.hasOwnProperty('mdAutohide')
                ;(t || e || r[0].activeElement !== w[0]) &&
                  (w.off('blur mouseleave touchend touchcancel', c), C(!1)),
                  (e = !1)
              }
    ...
    (function () {
      ...
      ;(o.$inject = ['$$rAF', '$scope', '$element', '$attrs']),
        ...
        (i.prototype.virtualRepeatUpdate_ = function (e, n) {
          ...
          for (var s = a - 1; a < this.newEndIndex; a++)
            (d = this.getBlock_(a)), this.updateBlock_(d, a), l.push(d)
          c.length &&
            ...
            l.length &&
              this.parentNode.insertBefore(
                ...
                this.blocks[s] && this.blocks[s].element[0].nextSibling,
              ),
    ...
    (function () {
      function e(e, o, a, d, c, l, s, m, u, h) {
        ...
        function f() {
          function e() {
            var e = re.scrollContainer.getBoundingClientRect(),
              n = {}
            e.right > o.right - i && (n.left = t.right - e.width + 'px'),
              re.$.scrollContainer.css(n)
          }
          ...
          d > c && o.height - t.bottom - i < r
            ? ((m.top = 'auto'),
              (m.bottom = c + 'px'),
              (m.maxHeight = Math.min(r, t.top - o.top - i) + 'px'))
            : ((m.top = d + 'px'),
              (m.bottom = 'auto'),
              (m.maxHeight = Math.min(r, o.bottom - t.bottom - i) + 'px')),
            re.$.scrollContainer.css(m),
            a.nextTick(e, !1)
        }
        function g() {
          re.$.root.length &&
            ...
            s.pin && s.pin(re.$.scrollContainer, m))
        }
        function b() {
        ...
        return (
          ...
          (te.registerSelectedItemWatcher = S),
          (te.unregisterSelectedItemWatcher = H),
            ...
            s = e.$watch(
              ...
              function (e, o) {
                ;(null === d || e.unsafeText !== o.unsafeText) &&
                  ...
                  (null === c || e.term !== o.term) && (c = a(e.term, l)),
      ...
      function e(e) {
        function t(t, n, o) {
          ...
          e(n.contents())(r.parent),
            o.hasOwnProperty('mdAutocompleteReplace') &&
              (n.after(n.contents()), n.remove())
        }
        ...
        function l(n, o) {
          ...
          return (
            ...
            function (n, r, i, d) {
              ...
              var p = d[0]
              if (
                ((p.chipContentsTemplate = s),
                (p.chipRemoveTemplate = l),
      ...
      function e(e, o, r, i, a, d) {
        ...
        ;(this.nestLevel = parseInt(o.mdNestLevel, 10) || 0),
          (this.init = function (e, t) {
            ;(t = t || {}),
              (c = e),
              (l = r[0].querySelector('[ng-click],[ng-mouseenter]')),
          ...
          (this.enableHoverListener = function () {
            i.$on('$mdMenuOpen', function (e, t) {
              c[0].contains(t[0]) &&
                ...
                (s.isAlreadyOpening = !1),
                s.currentlyOpenMenu.registerContainerProxy(
                  s.triggerContainerProxy.bind(s),
                ))
            }),
                ...
                e = d(
                  function () {
                    if (
                      ...
                      s.currentlyOpenMenu && s.currentlyOpenMenu != o)
                    ) {
                      var e = s.nestLevel + 1
          ...
          (this.close = function (n, o) {
            if (
              s.isOpen &&
              ((s.isOpen = !1), i.$emit('$mdMenuClose', r), e.hide(null, o), !n)
            ) {
        ...
        function o(e, o, a, d, c, l, s, m, u, h) {
          function p(n, o, r) {
            return r.nestLevel
              ...
              : (r.disableParentScroll && !e.getClosest(r.target, 'MD-DIALOG')
                ...
                function () {
                  r.backdrop &&
                    (r.backdrop.off('click'),
                    u.leave(r.backdrop, { duration: 0 })),
          ...
          function g(n, r, i) {
            ...
            function f() {
              ...
              var c =
                i.menuContentEl[0].querySelector('[md-menu-focus-target]') ||
                i.menuContentEl[0].firstElementChild.querySelector(
                  '[tabindex]',
                ) ||
                i.menuContentEl[0].firstElementChild.firstElementChild
              return (
                c.focus(),
                function () {
          ...
          function v(e, t) {
            t.preserveElement
              ...
              : r(e).parentNode === r(t.parent) && r(t.parent).removeChild(r(e))
          }
          function M(t, o) {
            function r(e) {
              ;(e.top = Math.max(
                Math.min(e.top, M.bottom - u.offsetHeight),
                M.top,
              )),
                (e.left = Math.max(
                  Math.min(e.left, M.right - u.offsetWidth),
                  M.left,
                ))
            }
            function a() {
              for (var e = 0; e < h.children.length; ++e)
                if ('none' != c.getComputedStyle(h.children[e]).display)
                  return h.children[e]
            }
            var l,
              s,
            ...
            if (
              ...
              ;(l = l.firstElementChild || l),
                (l = l.querySelector('[md-menu-align-target]') || l),
            ...
            switch ($.left) {
              case 'target':
                ...
                break
              case 'target-right':
                ;(y.left = v.right - p.width + (p.right - s.right)),
                  (C += 'right')
                break
              case 'cascade':
                var A = v.right + p.width < M.right
                ;(y.left = A
                  ? v.right - E.style.left
                  : v.left - E.style.left - p.width),
                  (C += A ? 'left' : 'right')
                break
              case 'left':
            ...
            var k =
                Math.round(100 * Math.min(v.width / u.offsetWidth, 1)) / 100,
    ...
    (function () {
      function e(e, n, o, r, i, a, d, c, l, s) {
        ...
        function D() {
          e.$apply(function () {
            ;(ae.lastSelectedIndex = ae.selectedIndex),
              ...
              a.nextTick(ae.updateInkBarStyles, !1),
              a.nextTick(W)
          })
        }
        function I(e) {
        ...
        var ae = this,
          ...
          me = !1
        f('stretchTabs', E),
          V('focusIndex', A, ae.selectedIndex || 0),
          V('offsetLeft', C, 0),
          V('hasContent', y, !1),
          V('maxTabWidth', M, Y()),
          V('shouldPaginate', $, !1),
