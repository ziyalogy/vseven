	...
	{if $BLOCK_FIELDS|@count gt 0}
		<div class='fieldBlockContainer'>
			...
			<div class="lineitemTableContainer">
				<table class="table table-stripedtable-bordered" id="lineItemTab">
					<tr>
		...
		<br>
		<div class="fieldBlockContainer">
			<table class="table table-stripedtable-bordered blockContainer lineItemTable" id="lineItemResult">
				<tr>
					<td width="83%">
					...
					<tr>
						...
						<td>
							...
							<div id="finalDiscountUI" class="finalDiscountUI validCheck hide">
								...
								<table width="100%" border="0" cellpadding="5" cellspacing="0" class="table table-stripedtable-nobordered popupTable">
									<tbody>
										<tr>
					...
					<tr>
						<td width="83%">
							...
							<div id="chargeTaxesBlock" class="hide validCheck chargeTaxesBlock">
								...
								<table class="table table-stripedtable-nobordered popupTable">
									<tbody>
										{foreach key=CHARGE_ID item=CHARGE_MODEL from=$INVENTORY_CHARGES}
