		...
		{if !$RECORD_EXISTS}
			<div class="mailConveterDesc">
				<center><br><br>
					...
					<a onclick="window.location.href='{$MODULE_MODEL->getCreateRecordUrl()}'" style="color: #38a767 !important;"><u class="cursorPointer" style="font-size:12pt;">{vtranslate('LBL_CREATE_MAILBOX_NOW', $QUALIFIED_MODULE)}</u></a>
					<br><br>
				</center>
			</div>
		{else}
