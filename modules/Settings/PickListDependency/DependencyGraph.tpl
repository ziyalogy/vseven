...
{strip}
    ...
    <div class="row depandencyTable" style="padding-right: 10px;">
        <div class="col-sm-2 col-xs-2" style="padding-right: 0px;">
            <table class="listview-table table-striped table-bordered table-condensed" style="width: 100%; border-collapse:collapse;">
                <thead>
        ...
        <div class="col-sm-10 col-xs-10 dependencyMapping">
            <table class="listview-table table-striped table-bordered pickListDependencyTable" style="width:auto;">
                <thead>
    ...
    <div class="modal-dialog modal-lg sourcePicklistValuesModal modalCloneCopy hide">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table  class="table table-stripedtable-condensed table-borderless" cellspacing="0" cellpadding="5">
                    <tr>
